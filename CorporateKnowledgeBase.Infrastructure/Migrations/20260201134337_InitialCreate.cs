    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagTechnicalDocument", x => new { x.DocumentsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_TagTechnicalDocument_Documents_DocumentsId",
                        column: x => x.DocumentsId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagTechnicalDocument_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLikes_BlogPosts_BlogPostId",
                        column: x => x.BlogPostId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserLikes_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagTechnicalDocument_TagsId",
                table: "TagTechnicalDocument",
                column: "TagsId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikes_BlogPostId",
                table: "UserLikes",
                column: "BlogPostId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikes_DocumentId",
                table: "UserLikes",
                column: "DocumentId");
        }
